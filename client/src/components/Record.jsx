...
async function onSubmit(e) {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:6969/record${params.id ? "/"+params.id : ""}`, {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const response = await fetch(
        `http://localhost:6969/record/${params.id.toString()}`
      );
      if (!response.ok) {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      if (isNew) {
        ...
        response = await fetch("http://localhost:6969/record", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
        ...
        response = await fetch(`http://localhost:6969/record/${params.id}`, {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
          },
